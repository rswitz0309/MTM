...
const FeatureSection = () =>{
    return (
        <div id = "features-section" className = "relative mt-20 border-b bordeur neutral-800 min-h-[800px]">
            <div className="text-center">
                <span className="bg-neutral-900 text-blue-400 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase">
                    Features
                </span>
                <h2 className="text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking wide">
                    Everything you couldn't truckin' do  
                    ...
                    <div key = {index} className="w-full sm:1/2 lg:w-1/3">
                        <div className="flex">
                            ...
                            <div>
                                ...
                                <p className="text-md p-2 mb-20 text-neutral-500 max-w-[350px]">{feature.description}</p>
                            </div>
                        </div>
                    </div>
                ))};
